...
class Route
{
    ...
    public static function get($uris, $callback)
    {
        self::$routes["GET"][self::$URL_BASE . $uris] = $callback;
    }

    public static function post($uris, $callback)
    {
        self::$routes["POST"][self::$URL_BASE . $uris] = $callback;
    }
